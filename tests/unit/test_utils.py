...
class TestAnnotateIntext:
    def test_annotate_intext(self):
        ...
        doc.annotations.add(Annotation(text="Japan", start_char=30, end_char=35, tag="location"))

        expected_text = "My name is <NAME>John</NAME> and I live in <LOCATION>Japan</LOCATION>"
